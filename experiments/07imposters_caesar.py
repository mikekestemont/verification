"""Imposter approach for modern corpora. Used to generate Figs. 3.x and Table 2.x"""
...
feature_ranges = [int(x) for x in np.linspace(V, V*2, n_experiments)]
