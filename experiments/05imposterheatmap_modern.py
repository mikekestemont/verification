"""Visulaize effect of potential and actual impostors on modenr data. Used to generate Fig. 4"""
...
V = int(len(set(sum(X_train.texts, []) + sum(X_test.texts, [])))/2.0)
